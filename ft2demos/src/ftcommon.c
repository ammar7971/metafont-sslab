...
printf(" new face function called first time \n");
...
printf(" new face function called second time \n");
...
printf(" new face function called third time \n");
      ...
      {
printf(" new face function called fourth time \n");
